            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <div class="float-end">
                            <a href="movie/<?php echo e($r->id); ?>" class="btn btn-primary btn-sm"> <i
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\webserver\htdocs\LARAVEL\movie_project\resources\views/content/movie.blade.php ENDPATH**/ ?>